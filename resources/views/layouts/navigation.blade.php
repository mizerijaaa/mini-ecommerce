        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::check() ? route('dashboard') : route('market.index') }}">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('register') }}" class="inline-flex items-center rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white hover:bg-gray-800">
                            Sign up
                        </a>
                    </div>
                @endauth
